...
@EnableJpaRepositories(basePackages = {"com.qiu.security.server.dao"})//启用JPA资源库并指定资源库接口位置
@EntityScan(basePackages = {"com.qiu.microserviceprovideruserservice.entity"})//指定实体的位置
public class JPAConfig {



    private static final org.slf4j.Logger LOGGER = LoggerFactory.getLogger(JPAConfig.class);
   ...
   @Bean(name = "druidDataSource")
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource druidDataSource){
        ...
        localContainerEntityManagerFactoryBean.setPackagesToScan("com.qiu.security.server.model");
