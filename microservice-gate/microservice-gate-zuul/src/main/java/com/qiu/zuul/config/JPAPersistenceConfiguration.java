...
@EnableJpaRepositories(basePackages = {"com.qiu.ratelimiter.adapter","com.qiu.common.dao"})//启用JPA资源库并指定资源库接口位置
@EntityScan(basePackages = {"com.qiu.ratelimiter.adapter","com.qiu.zuul.entity","com.qiu.common.entity"})//指定实体的位置
public class JPAPersistenceConfiguration {
   ...
   @Bean(name = "druidDataSource")
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(DataSource druidDataSource){
        ...
        localContainerEntityManagerFactoryBean.setPackagesToScan(new String[]{"com.qiu.ratelimiter","com.qiu.zuul.entity","com.qiu.common.entity"});
        //localContainerEntityManagerFactoryBean.setPackagesToScan("com.qiu.common.entity");
        localContainerEntityManagerFactoryBean.setJpaProperties(buildHibernateProperties());localContainerEntityManagerFactoryBean.setJpaVendorAdapter(new HibernateJpaVendorAdapter(){
            {
